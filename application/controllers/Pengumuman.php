...
class Pengumuman extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['status'] = $this->m_topsis->ambil_status_pengumuman();
		$this->load->view('peserta/pengumuman', $data);
	}
	...
	public function aktif() {
        $this->simple_login->cek_login(1);
        $this->m_topsis->aktif_pengumuman();
        redirect('pengumuman/setting'); 			
	}

	public function nonaktif() {
        $this->simple_login->cek_login(1);
        $this->m_topsis->nonaktif_pengumuman();
        redirect('pengumuman/setting');
	}
}
