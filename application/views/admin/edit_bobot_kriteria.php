...
<head>
    ...
    <title>Dinas Pariwisata   | Edit Bobot Kriteria</title>
                    ...
                    <div class="col-md-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Form Edit Bobot Kriteria</h5>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <form class="m-t" role="form" action="<?php echo site_url('bobot_kriteria/edit_bobot_form'); ?>" method="post">
                                                 <table class="table table-striped table-bordered table-hover dataTables-example">
                                                    ...
                                                    <?php foreach ($kriteria as $key => $k) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" name="bobot[]" class="form-control" max="5" min="0" value="<?php echo $k['bobot']; ?>" required></td>
                                                        </tr>
                                                    <?php } ?>
                                                    </tbody>
                                                </table>
