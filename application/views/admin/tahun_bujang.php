                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-success dim" onclick="location.href='<?php echo site_url('kalkulasi_topsis/bujang/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-eye"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
