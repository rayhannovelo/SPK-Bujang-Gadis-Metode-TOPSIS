...
<head>
    ...
    <title>Dinas Pariwisata   | Daftar Peserta</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <?php if($daftar_peserta_bujang != NULL) foreach ($daftar_peserta_bujang as $dpb) { ?>
                                                <tr>
                                                    <td><?php echo $dpb['tahun']; ?></td>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <?php if($daftar_peserta_gadis != NULL) foreach ($daftar_peserta_gadis as $dpg) { ?>
                                                <tr>
                                                    <td><?php echo $dpb['tahun']; ?></td>
