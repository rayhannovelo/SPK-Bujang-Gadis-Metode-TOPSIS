                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-info dim" onclick="location.href='<?php echo site_url('input_nilai/attitude_bujang/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-edit"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
