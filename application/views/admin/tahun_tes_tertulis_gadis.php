                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-info dim" onclick="location.href='<?php echo site_url('input_nilai/tes_tertulis_gadis/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-edit"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
