...
<head>
    ...
    <title>Dinas Pariwisata   | Bobot Kriteria</title>
                        ...
                        <div class="ibox ">
                            <div class="ibox-title">
                                ...
                                <div class="text-right">
                                    <button class="btn btn-info dim" onclick="location.href='<?php echo site_url('bobot_kriteria/edit_bobot/')?>'" type="button"><i class="fa fa-edit"></i> Edit Bobot Kriteria</button>
                                </div>
                            </div>
