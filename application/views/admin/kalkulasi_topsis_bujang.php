...
<head>
    ...
    <title>Dinas Pariwisata   | Kalkulasi TOPSIS Bujang</title>
        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="active"><a href="<?php echo site_url('kalkulasi_topsis/tahun_bujang')?>">Bujang</a></li>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            $bmi = $p['berat_badan'] / pow(($p['tinggi_badan'] / 100), 2); 
                                                            echo number_format($bmi, 3, '.', ',');
                                                        ?>
                                                    </td>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo 'AP'.($key + 1); ?></td>
                                                    <td><?php echo $p['nama_lengkap']; ?></td>
                                                    <td><?php echo number_format($d_positif[$key], 3, '.', ','); ?></td>
                                                    <td><?php echo number_format($d_negatif[$key], 3, '.', ','); ?></td>
