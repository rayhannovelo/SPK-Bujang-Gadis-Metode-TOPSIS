...
<head>
    ...
    <title>Dinas Pariwisata   | Tahun Kalkulasi</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="<?php echo site_url('kalkulasi_topsis/tahun_gadis')?>">Gadis</a></li>
                    </ul>
                </li>
                <li>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-success dim" onclick="location.href='<?php echo site_url('kalkulasi_topsis/gadis/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-eye"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
