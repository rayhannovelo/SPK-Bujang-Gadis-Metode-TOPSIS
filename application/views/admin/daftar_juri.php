                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <?php if($daftar_juri != NULL) foreach ($daftar_juri as $dj) { ?>
                                                <tr>
                                                    <td><?php echo $dj['username']; ?></td>
                                                    <td><?php echo $dj['nama_juri']; ?></td>
                                                    <td><?php echo $dj['jenis_kelamin']; ?></td>
                                                    <td><?php echo $dj['nama_kriteria']; ?></td>
                                                    <td><button class="btn btn-info dim" onclick="location.href='<?php echo site_url('daftar_juri/edit_juri/'.$dj['id_users'])?>'" type="button"><i class="fa fa-edit"></i></button></td>
                                                    <!-- 
                                                    <td>
                                                        <div class="btn-group">
                                                        <button class="btn btn-info dim" onclick="location.href='<?php echo site_url('juri/edit_juri/'.$dj['id_juri'])?>'" type="button"><i class="fa fa-edit"></i></button>
                                                        <button class="btn btn-danger dim" onclick="if (confirm('Data peserta akan dihapus, apakah Anda yakin?')) location.href='<?php echo site_url('daftar_juri/hapus_juri/'.$dj['id_users'])?>'" type="button"><i class="fa fa-trash"></i> </button>
                                                        </div>
                                                    </td>
                                                    -->
                                                </tr>
