            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="active"><a href="<?php echo site_url('daftar_rangking/bujang'); ?>">Bujang</a></li>
                        <li><a href="<?php echo site_url('daftar_rangking/gadis'); ?>">Gadis</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <div class="col-md-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Daftar Rangking Peserta Bujang</h5>
                            </div>
