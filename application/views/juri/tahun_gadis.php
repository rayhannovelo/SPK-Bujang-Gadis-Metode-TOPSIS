            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="<?php echo site_url('daftar_rangking/tahun_gadis'); ?>">Gadis</a></li>
                    </ul>
                </li>
                <li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <?php if($tahun_nilai_gadis != NULL) foreach ($tahun_nilai_gadis as $dnb) { ?>
                                                <tr>
                                                    <td><?php echo $dnb['tahun']; ?></td>
                                                    <td><button class="btn btn-success dim" onclick="location.href='<?php echo site_url('daftar_rangking/gadis/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-eye"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
