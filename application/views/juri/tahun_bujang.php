        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="active"><a href="<?php echo site_url('daftar_rangking/tahun_bujang'); ?>">Bujang</a></li>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-success dim" onclick="location.href='<?php echo site_url('daftar_rangking/bujang/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-eye"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
