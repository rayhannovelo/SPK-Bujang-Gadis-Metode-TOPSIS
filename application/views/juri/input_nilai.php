...
<head>
    ...
    <title>Dinas Pariwisata   | Dashboard Juri</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="<?php echo site_url('input_nilai/'.$url); ?>"><i class="fa fa-edit"></i> <span class="nav-label">Input Nilai <?php echo $nama_tes; ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li <?php echo $tipe == 'Bujang' ? 'class="active"' : ''; ?>><a href="<?php echo site_url('input_nilai/tahun_'.$url2.'_bujang'); ?>">Bujang</a></li>
                        <li <?php echo $tipe == 'Gadis' ? 'class="active"' : ''; ?>><a href="<?php echo site_url('input_nilai/tahun_'.$url2.'_gadis'); ?>">Gadis</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Daftar Rangking</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo site_url('daftar_rangking/tahun_bujang'); ?>">Bujang</a></li>
                        <li><a href="<?php echo site_url('daftar_rangking/tahun_gadis'); ?>">Gadis</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <div class="col-md-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Form Input Nilai <?php echo $nama_tes.' '.$tipe; ?></h5>
                            </div>
                            <div class="ibox-content" style="background-color: white">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form action="<?php echo site_url('input_nilai/input_nilai_form/'.$url.'/'.$tahun); ?>" method="post">
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    echo '<input type="hidden" name="id_nilai_kriteria[]" value="'.$nk['id_nilai_kriteria'].'">';
                                                ?>
                                                <tr>
                                                    <td><?php echo $x; ?></td>
                                                    <td><?php echo $nk['nama_lengkap']; ?></td>
                                                    <td><?php echo '<input type="number" min="0" max="100" name="nilai_kriteria[]" class="form-control" placeholder="Nilai '.$nama_tes.'" required="" value="'.$nk['nilai_kriteria'].'">'?></td>
                                                </tr>
                                                <?php $x++; } ?>
                                            </tbody>
                                            </table>
