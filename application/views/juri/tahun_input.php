                    ...
                    <div class="col-md-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Daftar Tahun <?php echo $tipe; ?></h5>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-info dim" onclick="location.href='<?php echo site_url('input_nilai/'.$url.'/'.$dnb['tahun'])?>'" type="button"><i class="fa fa-edit"></i></button></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                            </table>
